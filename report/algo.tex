% File: algo.tex
% Date: Fri May 03 17:27:04 2013 +0800
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.36]{res/match.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=]{res/distort.png}
  \caption{Vertical Distortion with Homography on a Planar\label{fig:distort}}
\end{figure}

If \verb|TRANS = 0|, all the input images will be
\end{enumerate}
