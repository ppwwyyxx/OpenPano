% File: algo.tex
% Date: Fri May 03 17:38:20 2013 +0800
...
Therefore, if the option \verb|TRANS = 0|, all the input images will be projected to a cylinder before stitching. See \figref{cyl}
\end{enumerate}
